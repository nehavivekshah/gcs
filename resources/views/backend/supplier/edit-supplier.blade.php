  ...
  <div class="row">
    ...
    <div class="col-xl-12">
      <div class="card height-equal">
        ...
        <div class="card-body">
          <form class="row g-3 needs-validation custom-input" novalidate="" method="post" action="{{ route('admin.supplier.update', ['uuid' => $suppliers->uuid]) }}">
            @csrf
            @method('PATCH')
            ...
            <div class="row gy-3">
              ...
              <div class="col-4">
                ...
                <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="{{ $suppliers->mobile_no }}">
                <div class="invalid-feedback">@error('mobile_no') {{ $message }} @enderror</div>
              </div>

              <div class="col-4">
                <label class="form-label" for="contact_person">Contact Person</label>
                <input type="text" class="form-control" id="contact_person" name="contact_person" value="{{ $suppliers->contact_person }}">
              ...
              <div class="col-6">
                ...
                <input type="text" class="form-control" id="address_line_1" name="address_line_1" value="{{ $suppliers->address_line_1 }}">
              ...
              <div class="col-6">
                ...
                <input type="text" class="form-control" id="address_line_2" name="address_line_2" value="{{ $suppliers->address_line_2 }}">
              ...
              <div class="col-4">
                ...
                <input type="text" class="form-control" id="web_sites" name="web_sites" value="{{ $suppliers->web_sites }}">
