      ...
      <div class="col-6">
        <ol class="breadcrumb">
          <a href="{{ route('admin.supplier.create') }}">
            <button type="button" class="btn btn-lg" data-bs-toggle="tooltip" title="Add Supplier" style="background:#bf0103;color:white;">Add Supplier</button>
          </a>
        </ol>
      </div>
    </div>
                  ...
                  <td class="text-center">
                    <ul style="display:flex;align-items:center;gap:8px;padding:0;margin:0;list-style:none;justify-content:center;">
                      ...
                      <li>
                        <button
                          type="button"
                          class="btn btn-sm viewBranchBtn"
                          style="background:#bf0103;color:#fff;border:none;"
                          data-supplier-id="{{ $suppliers->id }}"
                      ...
                      <li>
                        <button
                          type="button"
                          class="btn btn-sm viewContactBtn"
                          style="background:#bf0103;color:#fff;border:none;"
                          data-supplier-id="{{ $suppliers->id }}"
                          data-supplier-uuid="{{ $suppliers->uuid }}"
                          data-supplier-name="{{ $suppliers->supplier_name }}">
                      ...
                      <li class="dropdown" style="position:relative;">
                        <a href="javascript:void(0)"
                          ...
                          <!-- Vertical dots -->
                          <i class="icon-more"
                            style="font-size:18px;display:inline-block;transform:rotate(90deg);">
                          </i>
                        </a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end"
                          ...
                          <!-- VIEW -->
                          <li>
                            <a class="dropdown-item viewSupplier"
                              href="javascript:void(0)"
                              style="color:#000;font-weight:600;"
                              data-id="{{ $suppliers->id }}"
                              data-uuid="{{ $suppliers->uuid }}"
                              ...
                              data-city_name="{{ $suppliers->city_name }}"
                              data-area_name="{{ $suppliers->area_name }}"
                              data-web_sites="{{ $suppliers->web_sites }}"
                              data-gst="{{ $suppliers->gst }}"
                              data-cst="{{ $suppliers->cst }}"
                              data-vat="{{ $suppliers->vat }}"
                              data-pan="{{ $suppliers->pan }}"
                              data-tin="{{ $suppliers->tin }}"
                              data-pincode="{{ $suppliers->pincode }}"
                              data-phone_1="{{ $suppliers->phone_1 }}"
                              data-phone_2="{{ $suppliers->phone_2 }}"
                              data-fax="{{ $suppliers->fax }}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="d-flex justify-content-between mb-3">
          ...
          <a href="javascript:void(0)" class="btn btn-sm" id="addBranchBtn" style="background:#bf0103;color:white;">Add Branch</a>
        </div>
...
<div class="modal fade" id="editBranchModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header" style="background:#bf0103;">
        <h5 class="modal-title" style="background:#bf0103;color:white;">Edit Branch <span id="editbranchSupplierName"></span></h5>
