        ...
        <div class="col-6">
          <div class="col-6">
            <ol class="breadcrumb justify-content-end">
              ...
              <a href="{{ route('admin.supplier.create') }}" class="ms-3">
                <button type="button" class="btn btn-primary-custom" data-bs-toggle="tooltip" title="Add Supplier">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <div class="d-flex justify-content-center align-items-center gap-2">
                            ...
                            <!-- VIEW -->
                            <a class="btn btn-sm-custom btn-outline-dark viewSupplier" href="javascript:void(0)"
                              data-id="{{ $suppliers->id }}" data-uuid="{{ $suppliers->uuid }}"
                              data-supplier_name="{{ $suppliers->supplier_name }}"
                              data-mobile_no="{{ $suppliers->mobile_no }}"
                              data-contact_person="{{ $suppliers->contact_person }}" data-email="{{ $suppliers->email }}"
                              data-address_line_1="{{ $suppliers->address_line_1 }}"
                              data-address_line_2="{{ $suppliers->address_line_2 }}"
                              data-state_name="{{ $suppliers->state_name }}" data-city_name="{{ $suppliers->city_name }}"
                              data-area_name="{{ $suppliers->area_name }}" data-web_sites="{{ $suppliers->web_sites }}"
                              data-gst="{{ $suppliers->gst }}" data-cst="{{ $suppliers->cst }}"
                              data-vat="{{ $suppliers->vat }}" data-pan="{{ $suppliers->pan }}"
                              data-tin="{{ $suppliers->tin }}" data-pincode="{{ $suppliers->pincode }}"
                              data-phone_1="{{ $suppliers->phone_1 }}" data-phone_2="{{ $suppliers->phone_2 }}"
                              data-fax="{{ $suppliers->fax }}" data-bs-toggle="tooltip" title="View">
                              <i class="icon-eye"></i>
                            </a>

                            <!-- EDIT -->
                            <a href="{{ route('admin.supplier.edit', ['uuid' => $suppliers->uuid]) }}"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-flex justify-content-between mb-3">
              ...
              <a href="javascript:void(0)" class="btn btn-sm" id="addBranchBtn"
                style="background:#bf0103;color:white;">Add
                Branch</a>
            </div>
