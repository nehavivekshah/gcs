                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <ul
                          ...
                          <a
                            href="{{ route('admin.customer.amc.product.list', ['customer_id' => $customer->id, 'branch_id' => $customerBranch->id, 'amc_product_id' => $amcProduct->id]) }}">
                            <button type="button" class="btn btn-sm" style="background:#bf0103;color:#fff;border:none;">
                              View
                            </button>
                          </a>
                        </ul>
