...
@section('main-section')
  <div class="container-fluid">
    <div class="page-title">
      <div class="row">
        <div class="col-6">
          <h4>{{ $customer->company_name }} - {{ $customerBranch->branch_name }} ({{ $amcProduct->amc_product }})</h4>
        </div>
        <div class="col-6">
          ...
          <ol class="breadcrumb">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="button" class="btn btn-lg addProductBtn" style="background:#bf0103;color:white;"
              data-bs-toggle="modal" data-bs-target="#addProductModal" data-customer_id="{{ $customer->id }}"
              data-branch_id="{{ $customerBranch->id }}" data-amc_product_id="{{ $amcProduct->id }}">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <ul class="action">
                          ...
                          <li class="edit">
                            <i class="icon-eye viewCustomerBtn" style="cursor:pointer;"
                              data-company_name="{{ $customer->company_name }}"
                              data-branch_name="{{ $customerBranch->branch_name }}"
                              data-amc_product="{{ $amcProduct->amc_product }}" data-user_name="{{ $amc->user_name }}"
                              data-department="{{ $amc->department }}" data-description="{{ $amc->description }}"
                              data-quantity="{{ $amc->quantity }}" data-invoice_type="{{ $amc->invoice_type }}"
                              data-amc_start_date="{{ $amc->amc_start_date }}" data-amc_end_date="{{ $amc->amc_end_date }}"
                          ...
                          <li class="edit">
                            <i class="icon-pencil-alt editProductBtn" data-id="{{ $amc->id }}" data-uuid="{{ $amc->uuid }}"
                              data-customer_id="{{ $amc->customer_id }}" data-branch_id="{{ $amc->branch_id }}"
                              data-amc_product_id="{{ $amc->amc_product_id }}" data-product_type="{{ $amc->product_type }}"
                              data-product_category="{{ $amc->product_category }}" data-department="{{ $amc->department }}"
                              data-user_name="{{ $amc->user_name }}" data-description="{{ $amc->description }}"
                              data-amc_start_date="{{ $amc->amc_start_date }}" data-amc_end_date="{{ $amc->amc_end_date }}"
                              data-service_date_1="{{ $amc->service_date_1 }}"
        ...
        <div class="modal-body">
          <form method="POST" action="{{ route('admin.customer.edit.amc.product') }}">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <label class="fw-bold">Service Date 1</label>
                <input type="text" name="service_date_1" id="edit_service_date_1" class="form-control datepicker"
                  readonly>
              </div>
              <div class="col-md-6">
                <label class="fw-bold">Service Engineer 1</label>
              ...
              <div class="col-md-6">
                <label class="fw-bold">Service Date 2</label>
                <input type="text" name="service_date_2" id="edit_service_date_2" class="form-control datepicker"
                  readonly>
              </div>
              <div class="col-md-6">
                <label class="fw-bold">Service Engineer 2</label>
              ...
              <div class="col-md-6">
                <label class="fw-bold">Service Date 3</label>
                <input type="text" name="service_date_3" id="edit_service_date_3" class="form-control datepicker"
                  readonly>
              </div>
              <div class="col-md-6">
                <label class="fw-bold">Service Engineer 3</label>
