...
<div class="container-fluid">
  <div class="page-title">
    <div class="row">
      ...
      <div class="col-6">
        <ol class="breadcrumb">
          <a href="{{ route('admin.product-accessories.create') }}">
            <button type="button" class="btn btn-lg" data-bs-toggle="tooltip" title="Add User" style="background:#bf0103;color:white;">Add Product Accessories</button>
          </a>
        </ol>
      </div>
    </div>
