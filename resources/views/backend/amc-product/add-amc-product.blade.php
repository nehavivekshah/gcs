      ...
      <div class="row">
        ...
        <div class="col-6">
          <ol class="breadcrumb justify-content-end">
            ...
            <li class="breadcrumb-item active">Add AMC Product</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="card card-premium">
          ...
          <div class="card-body">
            <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
              action="{{ route('admin.amc-product.store') }}">
              @csrf
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="amc_product" name="amc_product"
                  placeholder="AMC Product Name" required value="{{ old('amc_product') }}">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="non_comp_amc_rate"
                  name="non_comp_amc_rate" placeholder="Rate" required value="{{ old('non_comp_amc_rate') }}">
                <div class="invalid-feedback">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="comp_amc_rate" name="comp_amc_rate"
                  placeholder="Rate" required value="{{ old('comp_amc_rate') }}">
                <div class="invalid-feedback">
                  @error('comp_amc_rate')
                    {{ $message }}
                  @enderror
