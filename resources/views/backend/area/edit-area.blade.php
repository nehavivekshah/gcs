  ...
  <div class="row">
    ...
    <div class="col-xl-12">
      <div class="card height-equal">
        ...
        <div class="card-body">
          <form class="row g-3 needs-validation custom-input" novalidate="" method="post" action="{{ route('admin.area.update',['uuid' => $area->uuid]) }}">
            @csrf
            @method('PATCH')

            <div class="col-4">
              <label class="form-label" for="area">Area</label>
              <input type="text" class="form-control" id="area" name="area" placeholder="Area" required_ value="{{ $area->area }}">
