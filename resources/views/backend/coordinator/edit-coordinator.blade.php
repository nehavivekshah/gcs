        ...
        <div class="card card-premium">
          ...
          <div class="card-body">
            <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
              action="{{ route('admin.coordinator.update', ['uuid' => $coordinators->uuid]) }}">
              @csrf
              @method('PATCH')
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="user_name" name="user_name"
                  placeholder="User Name" required value="{{ $coordinators->user_name }}">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="user_password" name="user_password"
                  placeholder="User Password" required value="{{ $coordinators->password }}">
                <div class="invalid-feedback">
                  @error('user_password')
                    {{ $message }}
                  @enderror
              ...
              <div class="col-md-4">
                ...
                <input type="email" class="form-control form-control-premium" id="outlook_email" name="outlook_email"
                  placeholder="Outlook Email" required value="{{ $coordinators->outlook_email }}">
                <div class="invalid-feedback">
                  @error('outlook_email')
                    {{ $message }}
                  @enderror
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="outlook_password" name="outlook_password"
                  placeholder="Outlook Password" required value="{{ $coordinators->outlook_password }}">
                <div class="invalid-feedback">
