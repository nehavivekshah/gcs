        ...
        <div class="card-body">
          <form class="row g-3 needs-validation custom-input" novalidate="" method="post" action="{{ route('admin.user.store') }}">
            ...
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="user_password" name="user_password" placeholder="User Password" required_ value="{{ old('user_password') }}">
              <div class="invalid-feedback">
                @error('user_password')
                {{ $message }}
                @enderror
            ...
            <div class="col-4">
              ...
              <input type="email" class="form-control" id="outlook_email" name="outlook_email" placeholder="Outlook Email" required_ value="{{ old('outlook_email') }}">
              <div class="invalid-feedback">
                @error('outlook_email')
                {{ $message }}
                @enderror
            ...
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="outlook_password" name="outlook_password" placeholder="Outlook Password" required_ value="{{ old('outlook_password') }}">
              <div class="invalid-feedback">
