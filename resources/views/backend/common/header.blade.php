...
<!-- Plugins css start-->
<link rel="stylesheet" type="text/css" href="{{ url('public/assets/css/vendors/slick.css') }}">
<link rel="stylesheet" type="text/css" href="{{ url('public/assets/css/vendors/slick-theme.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ url('public/assets/css/custom-enhanced.css') }}">