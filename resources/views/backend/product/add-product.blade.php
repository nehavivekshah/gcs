          ...
          <div class="card-body">
            <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
              ...
              <div class="col-md-4">
                ...
                <div class="d-flex">
                  <select class="form-control form-control-premium me-2 select2" id="manufacture" name="manufacture"
                    required>
                  ...
                  <button type="button" class="btn btn-sm-custom btn-outline-primary" data-bs-toggle="modal"
              ...
              <div class="col-md-4">
                ...
                <div class="d-flex">
                  <select class="form-control form-control-premium me-2 select2" id="product_type" name="product_type"
                    required>
                    <option value=""> Select </option>
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-premium" id="specification" name="specification"
                  value="{{ old('specification') }}" required>
      ...
      <div class="modal-content modal-content-premium">
        ...
        <div class="modal-body">
          <form id="manufactureForm" method="post" action="{{ route('admin.product.add.manufacture') }}">
            @csrf
            <div class="mb-3">
              <label for="manufacture" class="form-label-premium">Manufacture</label>
              <input type="text" class="form-control form-control-premium" id="manufacture_modal" name="manufacture"
                required>
            </div>
            <div class="d-flex justify-content-end">
      ...
      <div class="modal-content modal-content-premium">
        ...
        <div class="modal-body">
          <form id="productTypeForm" method="post" action="{{ route('admin.product.add.product.type') }}">
            @csrf
            <div class="mb-3">
              <label for="product_type" class="form-label-premium">Product Type</label>
              <input type="text" class="form-control form-control-premium" id="product_type_modal" name="product_type"
                required>
            </div>

            <div class="mb-3">
              <label for="sub_product_type" class="form-label-premium">Sub Product Type</label>
              <input type="text" class="form-control form-control-premium" id="sub_product_type_modal"
                name="sub_product_type" required>
            </div>
