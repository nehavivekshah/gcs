      ...
      <div class="row">
        ...
        <div class="col-6">
          <ol class="breadcrumb justify-content-end">
            ...
            <button type="button" class="btn btn-primary-custom ms-3" data-bs-toggle="modal" data-bs-target="#addProductModal">
                ...
                <tbody>
                  ...
                  @foreach($productList as $products)
                    ...
                    <tr>
                      ...
                      <td><span class="badge badge-light-success text-dark">₹{{ number_format($products->rate, 2) }}</span></td>
                      <td class="small">{{ $products->manufacture_name }} - {{ $products->product_type_name }} - {{ $products->sub_product_type }} - {{ $products->specification }}</td>
                      <td class="text-center">
                        <div class="d-flex justify-content-center align-items-center gap-2">
                          <a href="javascript:void(0);" class="btn btn-sm-custom btn-outline-dark editProductBtn"
                            data-uuid="{{ $products->uuid }}" 
                            data-manufacture="{{ $products->manufacture }}"
                            data-product_type="{{ $products->product_type }}"
                            data-sub_product_type_id="{{ $products->sub_product_type_id ?? $products->sub_product_type }}"
                            data-specification="{{ $products->specification }}"
                            data-rate="{{ $products->rate }}"
            ...
            <div class="row g-3">
              <div class="col-md-4">
                ...
                <div class="d-flex gap-2">
                  ...
                  <button type="button" class="btn btn-sm-custom btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addManufactureModal">
                    Add
                  </button>
                </div>
              </div>
              <div class="col-md-4">
                ...
                <div class="d-flex gap-2">
                  ...
                  <button type="button" class="btn btn-sm-custom btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addProductTypeModal">
                    Add
                  </button>
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="specification" class="form-control form-control-premium" placeholder="Enter Specification" required>
              </div>
              <div class="col-md-6">
                <label class="form-label-premium">Rate <span class="text-danger">*</span></label>
                <input type="text" name="rate" class="form-control form-control-premium" placeholder="Enter Rate" required>
              </div>
            </div>
          </div>
        ...
        <form id="editProductForm" method="POST" class="needs-validation" novalidate>
          ...
          <div class="modal-body p-4">
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <label class="form-label-premium">Specification <span class="text-danger">*</span></label>
                <input type="text" name="specification" id="edit_specification" class="form-control form-control-premium" placeholder="Enter Specification" required>
              </div>
              <div class="col-md-6">
                <label class="form-label-premium">Rate <span class="text-danger">*</span></label>
                <input type="text" name="rate" id="edit_rate" class="form-control form-control-premium" placeholder="Enter Rate" required>
              </div>
            </div>
          </div>
          <div class="modal-footer border-0 p-4 pt-0">
        ...
        <form action="{{ route('admin.product.add.manufacture') }}" method="POST">
          ...
          <div class="modal-body p-4">
            <div class="mb-3">
              ...
              <input type="text" name="manufacture" class="form-control form-control-premium" placeholder="Enter Manufacture Name" required>
            </div>
          </div>
          <div class="modal-footer border-0 p-4 pt-0">
            <button type="button" class="btn btn-secondary" data-bs-target="#addProductModal" data-bs-toggle="modal">Back</button>
        ...
        <form action="{{ route('admin.product.add.product.type') }}" method="POST">
          ...
          <div class="modal-body p-4">
            <div class="mb-3">
              ...
              <input type="text" name="product_type" class="form-control form-control-premium" placeholder="Enter Product Type" required>
            </div>
            <div class="mb-3">
              <label class="form-label-premium">Sub Product Type Name <span class="text-danger">*</span></label>
              <input type="text" name="sub_product_type" class="form-control form-control-premium" placeholder="Enter Sub Product Type" required>
            </div>
          </div>
          <div class="modal-footer border-0 p-4 pt-0">
            <button type="button" class="btn btn-secondary" data-bs-target="#addProductModal" data-bs-toggle="modal">Back</button>
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            $.each(res, function(key, value) {
              options += `<option value="${value.id}" ${ (selectedId == value.id || res.length == 1) ? 'selected' : ''}>${value.sub_product_type}</option>`;
            });
